...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { conditions: @trail.conditions, country_id: @trail.country_id, distance: @trail.distance, name: @trail.name } }
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { conditions: @trail.conditions, country_id: @trail.country_id, distance: @trail.distance, name: @trail.name } }
