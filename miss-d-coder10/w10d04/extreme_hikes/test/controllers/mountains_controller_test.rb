...
class MountainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mountain" do
    assert_difference('Mountain.count') do
      post mountains_url, params: { mountain: { date_of_first_summit: @mountain.date_of_first_summit, height: @mountain.height, image: @mountain.image, location: @mountain.location, name: @mountain.name } }
    end
  ...
  test "should update mountain" do
    patch mountain_url(@mountain), params: { mountain: { date_of_first_summit: @mountain.date_of_first_summit, height: @mountain.height, image: @mountain.image, location: @mountain.location, name: @mountain.name } }
